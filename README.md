## tradr_uol (kinetic) - 1.0.11-0

The packages in the `tradr_uol` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release -y --no-web -t kinetic -r kinetic tradr_uol` on `Mon, 05 Nov 2018 18:28:21 -0000`
